...
def downloadTims():
	...
	for pastSeconds in range(timeInterval):
		...
		if day == '28':
			# filePath = "./pythonScript/traffic2806" + "/" + fileName
			filePath = "d:\\Github\\Exhibition-Road-Festival\\pythonScript\\traffic2806" + "\\" + fileName
		elif day == '29':
			# filePath = "./pythonScript/traffic2906" + "/" + fileName
			filePath = "d:\\Github\\Exhibition-Road-Festival\\pythonScript\\traffic2906" + "\\" + fileName
		else:
			# filePath = "./pythonScript/traffic3006" + "/" + fileName
			filePath = "d:\\Github\\Exhibition-Road-Festival\\pythonScript\\traffic3006" + "\\" + fileName
...
def downloadCurrentTrafficData():
