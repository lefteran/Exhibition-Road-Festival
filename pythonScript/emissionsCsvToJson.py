...
def exportAvgEmissionsToJson(filename, weekendSensorsEmissionsDict, todaysSensorsEmissionsDict):
    fp = open(filename,"w")
    fp.write("data = \'[")
...
exportAvgEmissionsToJson("emissionData.json", weekendSensorsEmissionsDict, todaysSensorsEmissionsDict)